...
elseif RecSel == 4
    % NeuraLynx
    HardwareFuncs = struct(...
        'SetupRecording', @connect_Nlx, ...
        'ShutdownRecording', @disconnect_Nlx, ...
        'InitRawData', @initRawData_Nlx, ...
        'GetNewRawData', @getNewRawData_Nlx, ...
        'GetTime', @(inittic) toc(inittic) ... REPLACE WITH NLX FUNCTION OR NlxSendCommand
        );
else
