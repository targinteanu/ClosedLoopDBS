...
if RecSel == 1
    ...
    HardwareFuncs = struct(...
        ...
        'InitRecording', @(sz,fo,fw,i1,i2,i3,i4,i5) InitializeRecording(@initRawData_cbmex, sz,fo,fw,i1,i2,i3,i4,i5), ...
...
elseif RecSel == 2
    ...
    HardwareFuncs = struct(...
        ...
        'InitRecording', @(sz,fo,fw,i1,i2,i3,i4,i5) InitializeRecording(@initRawData_AO, sz,fo,fw,i1,i2,i3,i4,i5), ...
