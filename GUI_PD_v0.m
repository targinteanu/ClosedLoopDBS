...
% Last Modified by GUIDE v2.5 29-Sep-2025 13:26:10
...
try
    ...
    [handles, ~, phBuffers, phStorage] = ...
        ...
        {handles.h_peakTrace, handles.h_trouTrace, ...
         handles.h_redTrace, handles.h_yelTrace, handles.h_grnTrace, handles.h_stpTrace}, ...
        {handles.peakDataBuffer, handles.trouDataBuffer, ...
         handles.redDataBuffer, handles.yelDataBuffer, handles.grnDataBuffer, handles.stpDataBuffer}, ...
        {handles.pkStorage1, handles.trStorage1, handles.redStorage1, handles.yelStorage1, handles.grnStorage1, handles.stpStorage1; ...
         handles.pkP1,       handles.trP1,       handles.redP1,       handles.yelP1,       handles.grnP1,       handles.stpP1; ...
         handles.pkStorage2, handles.trStorage2, handles.redStorage2, handles.yelStorage2, handles.grnStorage2, handles.stpStorage2});

    % additional phase tracking buffers & plots

    handles.peakDataBuffer = phBuffers{1}; handles.trouDataBuffer = phBuffers{2}; 
    handles.redDataBuffer = phBuffers{3}; handles.yelDataBuffer = phBuffers{4}; 
    handles.grnDataBuffer = phBuffers{5}; handles.stpDataBuffer = phBuffers{6};
    ...
    handles.redStorage1   = phStorage{1,3}; handles.redP1   = phStorage{2,3}; 
    handles.redStorage2   = phStorage{3,3}; 
    handles.yelStorage1   = phStorage{1,4}; handles.yelP1   = phStorage{2,4}; 
    handles.yelStorage2   = phStorage{3,4}; 
    handles.grnStorage1   = phStorage{1,5}; handles.grnP1   = phStorage{2,5}; 
    handles.grnStorage2   = phStorage{3,5}; 
    handles.stpStorage1   = phStorage{1,6}; handles.stpP1   = phStorage{2,6}; 
    handles.stpStorage2   = phStorage{3,6}; 
...
try
    ...
    if handles.FilterSetUp
        if handles.MdlSetUp
            ...
            handles.redDataBuffer = false(sz);
            handles.yelDataBuffer = false(sz);
            handles.grnDataBuffer = false(sz);
            handles.stpDataBuffer = false(sz);

            axes(handles.ax_filt)
            handles.h_redTrace = plot(xValues3,nan(sz), ...
                's', 'Color',"#A2142F"); 
            handles.h_yelTrace = plot(xValues3,nan(sz), ...
                's', 'Color',"#EDB120"); 
            handles.h_grnTrace = plot(xValues3,nan(sz), ...
                's', 'Color',"#77AC30"); 
            handles.h_stpTrace = plot(xValues3,nan(sz), ...
                's', 'Color',"#7E2F8E"); 
        end
    end
